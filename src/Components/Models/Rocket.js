        ...
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          >
            <mesh castShadow geometry={nodes.Sphere__0.geometry}>
              <meshStandardMaterial color={colors.hull || "#ff0000"} name="hull" />
            </mesh>
          </group>
          <group
          ...
          >
            <mesh castShadow geometry={nodes.Cylinder__0.geometry}>
              <meshStandardMaterial color={colors.base || "#333333"} name="base" />
            </mesh>
          </group>
          <group
          ...
          >
            <mesh castShadow geometry={nodes.Sphere001__0.geometry}>
              <meshStandardMaterial color={colors.tip || "#ffffff"} name="tip" />
            </mesh>
          </group>
          <group
          ...
          >
            <mesh castShadow geometry={nodes.Cube001__0.geometry}>
              <meshStandardMaterial color={colors.wings || "#cccccc"} name="wings" />
            </mesh>
          </group>
          <group
          ...
          >
            <mesh castShadow geometry={nodes.Cylinder003__0.geometry}>
              <meshStandardMaterial color={colors.window || "#88ccff"} name="window" />
            </mesh>
          </group>
        </group>
      </group>
